...
class SateImage(Base):
    ...
    # loc_ver = Column(DECIMAL(precision=4, scale=16))
    # loc_hor = Column(DECIMAL(precision=4, scale=16))
    loc_ver = Column(DOUBLE)
    loc_hor = Column(DOUBLE)
    
    res_ver = Column(Integer)
    res_hor = Column(Integer)
    # b_left = Column(DECIMAL(precision=4, scale=16))
    # b_right = Column(DECIMAL(precision=4, scale=16))
    # b_top = Column(DECIMAL(precision=4, scale=16))
    # b_bottom = Column(DECIMAL(precision=4, scale=16))
